...
- Handle participants in deleted rooms ([!1853](https://git.opentalk.dev/opentalk/frontend/web/web-app/-/merge_requests/1853))
- Meeting notes participants list after join ([!1914](https://git.opentalk.dev/opentalk/frontend/web/web-app/-/merge_requests/1914))
- Ui issues after camera permission denial ([!1853](https://git.opentalk.dev/opentalk/frontend/web/web-app/-/merge_requests/1853))
...
- Preserve aspect ratio when activating background blur on android phones ([!1853](https://git.opentalk.dev/opentalk/frontend/web/web-app/-/merge_requests/1853))
- Apply background effects when local video is not rendered ([!1853](https://git.opentalk.dev/opentalk/frontend/web/web-app/-/merge_requests/1853))
- Background Image should now get cropped instead of scaled ([!1853](https://git.opentalk.dev/opentalk/frontend/web/web-app/-/merge_requests/1853))
