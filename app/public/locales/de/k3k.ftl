...
participant-list-self-description = Ich
...
toolbar-button-send-reaction-tooltip-title = Reaktion senden
toolbar-button-reactions-disabled = Der Moderator hat Reaktionen deaktiviert
...
more-menu-manage-waiting-room = Warteraum verwalten
more-menu-waiting-room-disabled = Inaktiv
more-menu-waiting-room-for-guests = Nur für Gäste
more-menu-waiting-room-for-everyone = Für alle Teilnehmer
more-menu-enable-guest-access = Gastzugang aktivieren
...
guest-access-enabled-message = Gastzugang aktiviert
guest-access-disabled-message = Gastzugang deaktiviert
disable-guest-access-dialog-title = Gastzugang deaktivieren?
disable-guest-access-dialog-content = Alle aktuell anwesenden Gäste werden sofort aus dem Meeting entfernt und können nicht mehr beitreten.
disable-guest-access-dialog-cancel = Abbrechen
disable-guest-access-dialog-confirm = Gastzugang deaktivieren
more-menu-enable-microphones = Mikrofone einschalten
more-menu-disable-microphones = Mikrofone ausschalten
more-menu-disable-display-name-change-restrictions = Namen bearbeiten aktivieren
more-menu-enable-display-name-change-restrictions = Namen bearbeiten deaktivieren
more-menu-enable-chat = Chat aktivieren
more-menu-disable-chat = Chat deaktivieren
more-menu-enable-reaction = Reaktionen aktivieren
more-menu-disable-reaction = Reaktionen deaktivieren
...
reaction-enabled-message = Reaktionen wurden vom Moderator aktiviert
reaction-disabled-message = Reaktionen wurden vom Moderator deaktiviert
reaction-floating-self-label = Ich
...
more-menu-start-remote-control = Remote Control App starten
...
moderationbar-button-reset-handraises-disabled-tooltip = Nicht verfügbar, da Melden per Handzeichen deaktiviert ist.
...
poll-input-option = Option hinzufügen {$number}
poll-input-option-button = Option hinzufügen
poll-input-option-max = Limit von {$max} Optionen erreicht
...
timer-overview-button-stop = Timer beenden
timer-notification-stopped = Der Timer wurde unterbrochen
timer-notification-ran-out = Die Zeit ist abgelaufen
timer-notification-error = Es gab ein Problem mit der Startzeit
timer-error-invalid-duration = Der Timer konnte nicht gestartet werden, da die Dauer ungültig ist.
timer-error-insufficient-permissions = Sie haben keine Berechtigung für diese Aktion.
timer-error-already-running = Es läuft bereits ein Timer.
timer-error-not-running = Es läuft derzeit kein Timer.
timer-error-ready-check-not-enabled = Die Bereitschaftsprüfung ist für diesen Timer nicht aktiviert.
timer-error-internal = Es ist ein Fehler aufgetreten und der Timer wurde gestoppt.
timer-popover-title = Ein Timer läuft
...
dashboard-direct-meeting-invitations-error = Es ist ein Problem beim Senden einer oder mehrerer Einladungen aufgetreten. Bitte versuchen Sie es erneut oder kontaktieren Sie Ihren Administrator.
...
dashboard-invite-to-meeting-copy-sip-link-aria-label = Telefoneinwahl-Informationen für {$eventTitle} kopieren
...
meeting-details-dialog-copy-meeting-link-success = Der Link wurde erfolgreich kopiert
...
meeting-details-dialog-label-meeting-link = Meeting-Link
...
meeting-details-dialog-aria-label-meeting-link = Meeting-Link kopieren für {$eventTitle}
...
hotkey-raise-hand-toggle = Hand heben / senken
hotkey-screen-share-toggle = Bildschirmfreigabe an / aus
...
layout-selection-trigger-button = Ansicht anpassen
layout-selection-title = Ansicht anpassen
layout-selection-select-view = Ansicht
layout-selection-dialog-description = Die Auswahl wird für zukünftige Meetings gespeichert.
layout-selection-speaker = Sprecher
layout-selection-grid = Kachel
layout-selection-fullscreen = Vollbild
layout-selection-sorting = Sortieren nach
layout-selection-grid-first-joined = Beitrittszeit
layout-selection-grid-first-joined-subtitle = Zuerst Beigetretene
layout-selection-grid-camera-first = Kamerastatus
layout-selection-grid-camera-first-subtitle = Aktive Kamera
layout-selection-grid-moderators-first = Rolle
layout-selection-grid-moderators-first-subtitle = Moderierende zuerst, dann Eingeladene, dann Gäste
layout-selection-grid-activity-first = Aktivität
layout-selection-grid-activity-first-subtitle = Sprechen und aktive Kamera
...
my-meeting-menu-activate-hotkeys = Tastaturkürzel
...
presence-logging-started-notification = Schulungs-Teilnahmeprotokollierung gestartet
presence-logging-ended-notification = Schulungs-Teilnahmeprotokollierung beendet
presence-logging-already-enabled-error = Schulungs-Teilnahmeprotokollierung bereits aktiviert
presence-logging-not-enabled-error = Schulungs-Teilnahmeprotokollierung nicht aktiviert
presence-logging-not-allowed-for-participant-error = Schulungs-Teilnahmeprotokollierung für den Teilnehmer nicht erlaubt
...
subtitle-notification-language-changed = Die Untertitel-Sprache wurde auf {$language} geändert.
