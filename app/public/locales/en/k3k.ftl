...
more-menu-disable-display-name-change-restrictions = Enable name editing
more-menu-enable-display-name-change-restrictions = Disable name editing
...
moderationbar-button-reset-handraises-disabled-tooltip = Not available while raise hand is disabled.
...
timer-error-invalid-duration = The timer could not be started because the duration is invalid.
timer-error-insufficient-permissions = You do not have permission to perform this action.
timer-error-already-running = A timer is already running.
timer-error-not-running = No timer is currently running.
timer-error-ready-check-not-enabled = The ready check is not enabled for this timer.
timer-error-internal = An error occurred and the timer was stopped.
...
lobby-password-placeholder = Enter password
lobby-password-step-heading = This room is password protected.
lobby-password-step-subtext = Access requires a valid password.
...
meeting-details-dialog-copy-meeting-link-success = The link was copied to your clipboard
...
meeting-details-dialog-aria-label-meeting-link = Copy Meeting Link for {$eventTitle}
