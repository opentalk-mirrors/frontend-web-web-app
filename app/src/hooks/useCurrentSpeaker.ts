...
export function useCurrentSpeaker(): ConnectionIdentifier | undefined {
  ...
  return pinnedConnectionIdentifier || (sortedParticipants[0]?.identity as ConnectionIdentifier);
}
